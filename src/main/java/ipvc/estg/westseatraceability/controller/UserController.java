...
public class UserController {
    ...
    public ResponseEntity<?> addRoleToUser(@RequestBody RoleToUserForm form) {
        userService.addRoleToUser(form.getUserUuid(), form.getRoleName());
    ...
    public void addRoleToUser(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                Algorithm algorithm = Algorithm.HMAC256("secret".getBytes()); //FIXME: encrypted string that is decrypted in here
